...
_COACH_PAGES: list[str] = [
    ...
    (
        ...
        "\n"
        "Rate limits:\n"
        "- Coach shares the daily limit with /llm: 10 requests/day\n"
    ...
    (
        ...
        "\n"
        "Limits:\n"
        "  - 10 requests/day (shared with /llm)\n"
...
_LLM_PAGES: list[str] = [
    ...
    (
        "Model Tiers\n"
        "\n"
        "/llm uses AI models via OpenRouter. There are three tiers:\n"
        "\n"
        "free (default):\n"
        "  - Free models, no cost\n"
    ...
    (
        ...
        "\n"
        "Rate limits:\n"
        "  - 10 requests per day (shared with /coach)\n"
        "  - 30-second cooldown between requests\n"
        "  - Resets at midnight\n"
        "\n"
        "Agent loop:\n"
    ...
    (
        ...
        "  /llm compare build vs study hours\n"
        "  /llm suggest a quest for daily logging\n"
        "  /llm tier top_tier deep analysis of my habits\n"
        "\n"
