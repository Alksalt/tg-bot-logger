...
HELP_TOPICS: dict[str, str] = {
    ...
    "llm": (
        ...
        "/llm tier [name] — view/set model tier\n"
...
_LLM_PAGES: list[str] = [
    ...
    (
        ...
        "\n"
        "open_source_cheap:\n"
        "  Low-cost open source models, better reasoning.\n"
        "\n"
        "top_tier:\n"
        "  Direct provider APIs: GPT-5 Mini, Gemini 3 Flash,\n"
        "  Claude Haiku 4.5. Falls back to OpenRouter if needed.\n"
        "\n"
        "Set persistent tier:\n"
        "  /llm tier top_tier\n"
        "  /llm tier default     (reset to auto)\n"
        "\n"
        "Model shortcuts (top_tier, specific provider):\n"
    ...
    (
        ...
        "\n"
        "Model control:\n"
        "  /llm tier [name]     View/set tier\n"
        "  /llm models          Show available models\n"
        "  /llm gpt <q>         GPT-5 Mini\n"
        "  /llm claude <q>      Claude Haiku 4.5\n"
        "  /llm gemini <q>      Gemini 3 Flash\n"
        "\n"
        "Limits:\n"
        "  80 requests/day, 30s cooldown\n"
...
_QUESTS_PAGES: list[str] = [
    ...
    (
        ...
        "Quests are weekly and reset each week.\n"
