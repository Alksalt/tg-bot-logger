...
MESSAGES: Final[dict[str, dict[str, str]]] = {
    "en": {
        ...
        "llm_disabled_key": "LLM agent is disabled. Set OPENROUTER_API_KEY.",
        "search_working": "Searching web...",
    ...
    "uk": {
        ...
        "llm_disabled_key": "LLM-агент вимкнений. Додай OPENROUTER_API_KEY.",
        "search_working": "Шукаю в інтернеті...",
